...
const Privacy = (props) => {
  return(
    <Layout>
        ...
        <br/>
        Kami dapat menggunakan data yang Pengguna berikan dan informasi lainnya yang dikumpulkan melalui Situs untuk tujuan berikut:
        <ul>
        <li>mengelola dan/atau mengurus penggunaan dan/atau akses Situs;</li>
        <li>mengelola, mengoperasikan, mengurus dan memberikan Anda layanan yang ditawarkan di Situs;</li>
        <li>mempublikasikannya dalam bentuk data yang sudah diolah.</li>
        </ul>
        ...
        <br/>
        "Cookie" adalah pengidentifikasi alfanumerik yang kami transfer ke hard drive atau kartu memori Anda melalui web browser ketika Anda mengunjungi situs kami.
        Hal ini memungkinkan sistem milik kami sendiri untuk mengenali Anda ketika Anda kembali mengunjungi situs kami dan meningkatkan layanan kami kepada Anda.
        Informasi ini digunakan untuk melacak penggunaan pengunjung Situs dan mengkompilasi laporan statistik mengenai aktivitas Situs.
        Untuk informasi lebih lanjut tentang cookie, kunjungi www.aboutcookies.org atau www.allaboutcookies.org.
        Cookie juga dapat digunakan untuk mengkompilasi informasi keseluruhan tentang area Situs kami yang paling sering dikunjungi.
        Informasi lalu lintas ini dapat digunakan untuk meningkatkan konten Situs kami dan membuat penggunaan Anda menjadi lebih mudah.
        Jika Anda ingin menolak cookie kami, Anda dapat mengkonfigurasi browser Anda untuk melakukannya.
        Namun, beberapa fitur Situs kami mungkin tidak berfungsi jika Anda menghapus cookie dari browser Anda.
        Jika Anda tidak mengaktifkan cookie, Anda mungkin tidak dapat mengakses fungsi atau fitur penting pada Situs ini, dan Anda mungkin hanya dapat menggunakan Situs secara terbatas.
        <br/>
    
        <br/>
        <b>Persetujuan Perubahan Kebijakan Privasi</b>
        <br/>
        Dengan menggunakan Situs atau layanan yang kami sediakan, Anda setuju dengan pengumpulan, penggunaan, penyingkapan dan pengolahan Data Pribadi Anda sebagaimana diatur dalam Kebijakan Privasi ini.
        Lebih lanjut, jika Anda menggunakan layanan kami, kami berhak mengumpulkan, menggunakan, menyingkap dan memproses Data Pribadi Anda sesuai dengan Kebijakan Privasi ini.
        Dari waktu ke waktu, Kami dapat mengubah Kebijakan Privasi ini. Sebagaimana dijelaskan pada awal Kebijakan Privasi ini, kami akan menampilkan perubahan pada Situs ini untuk informasi Anda.
