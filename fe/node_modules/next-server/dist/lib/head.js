...
function Head({ children }) {
    return (react_1.default.createElement(amphtml_context_1.IsAmpContext.Consumer, null, (isAmp) => (react_1.default.createElement(head_manager_context_1.HeadManagerContext.Consumer, null, (updateHead) => (react_1.default.createElement(Effect, { reduceComponentsToState: reduceComponents, handleStateChange: updateHead, isAmp: isAmp }, children))))));
}
